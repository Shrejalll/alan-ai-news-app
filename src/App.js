...
const App = () => {
  ...
  useEffect(() => {
    alanBtn({
      key: '084107348c8e096f2d84bb4c0b5c22e02e956eca572e1d8b807a3e2338fdd0dc/stage',
      ...
      {!newsArticles.length ? (
        <div className={classes.footer}>
          <Typography variant="body1" component="h2">
            Created by :- 
            <a className={classes.link} href="https://www.linkedin.com/in/shrejal-mishra-9a8ba2223">Shrejal Mishra</a> -
            {/* <a className={classes.link} href="http://youtube.com/javascriptmastery"> JavaScript Mastery</a> */}
          </Typography>
          <img className={classes.image} src={logo} height="50px" alt="My logo" />
        </div>
      ) : null}
    </div>
  );
